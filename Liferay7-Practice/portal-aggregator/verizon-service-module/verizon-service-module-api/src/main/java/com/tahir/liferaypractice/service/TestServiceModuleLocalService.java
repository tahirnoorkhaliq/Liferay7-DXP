...
/**
 * Provides the local service interface for TestServiceModule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Tahir
 * @see TestServiceModuleLocalServiceUtil
...
public interface TestServiceModuleLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestServiceModuleLocalServiceUtil} to access the test service module local service. Add custom service methods to {@link com.tahir.liferaypractice.service.impl.TestServiceModuleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestServiceModule getTestServiceModuleByUuidAndGroupId(
